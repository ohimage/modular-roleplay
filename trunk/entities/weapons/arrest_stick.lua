...
function SWEP:PrimaryAttack()
	...
	trace.Entity:Arrest( NRP.cfg.JailTimer )
	NRP.Notice( player.GetAll(), 6, self.Owner:Name().." arrested "..trace.Entity:Name() )
	NRP.Notice( trace.Entity, 6, "You were arrested by "..self.Owner():Name(), Notice_ERROR )
end

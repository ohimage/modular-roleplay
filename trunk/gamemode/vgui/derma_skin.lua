...
SKIN.DermaVersion       = 1
SKIN.GwenTexture		= Material("neorp/neorp_gwen.png")
...
SKIN.Colours.Label.Bright				= Color( 75, 0, 0 );
SKIN.Colours.Label.Dark					= Color( 0, 0, 0 );
SKIN.Colours.Label.Highlight			= Color( 255, 255, 0 );
...
derma.DefineSkin("neorp", "A skin for NeoRoleplay", SKIN)